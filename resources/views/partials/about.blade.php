<section class="hero" id="about">
    ...
    <div class="container">
        <div class="hero-text">
            <p>Hello, I'm</p>
            <h2>Rido Izril Qonata</h2>

            <h4 class="role-marquee">
            ...
            <p>
                Hello! I'm Rido Izril Qonata, an Information Systems graduate with a passion
                for Fullstack Development, Frontend Development, and Backend Development.
                I enjoy building modern, user-friendly web applications and developing
    ...
    <div class="hero-buttons">
        ...
        <!-- Download CV -->
        <a href="https://drive.google.com/file/d/1PxwetqjP4_PZjnNWITSgXtSuEsd-0F2K/view?usp=sharing"
           class="btn-red"
           target="_blank"
           ...
           rel="noopener noreferrer">
            View Certificate
                ...
                <div class="hero-socials">
                    ...
                    <a href="https://instagram.com/ridoizril" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
        ...
        <div class="hero-image">
            ...
            <img src="{{ asset('images/foto.png') }}" alt="Foto profil Rido Izril Qonata">
        </div>
    </div>
</section>